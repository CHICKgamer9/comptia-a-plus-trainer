...
import { SUBJECTS, challengeHref, getChallengesBySubject, getSubject, isSubjectId } from "@/content";
    ...
    <div className="mx-auto max-w-xl">
      ...
      {subject === "tech" ? (
        <>
          ...
          <CoursePath subject="tech" exam="220-1101" />
          <h2 className="mt-10 mb-3 text-center text-xs uppercase tracking-wider text-muted">Core 2</h2>
          <CoursePath subject="tech" exam="220-1102" />
        </>
      ) : (
        <CoursePath subject={subject} />
      )}
      {challenges.length ? (
        <div className="mt-10">
