...
const loaders: Record<BrainCat, () => Promise<{ default: unknown }>> = {
  ...
  riddle: () => import("./packs/riddle.json"),
  trivia: () => import("./packs/trivia.json"),
  emoji: () => import("./packs/emoji.json"),
  odd: () => import("./packs/odd.json"),
  lie: () => import("./packs/lie.json"),
  micro: () => import("./packs/micro.json"),
  spell: () => import("./packs/spell.json"),
  fact: () => import("./packs/fact.json"),
  pattern: () => import("./packs/pattern.json"),
  ethic: () => import("./packs/ethic.json"),
  beat: () => import("./packs/beat.json"),
};
